package cn.edu.bistu.cs.se.logindialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button tip = (Button) this.findViewById(R.id.buttonTip);
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final EditText name = (EditText) loginView.findViewById(R.id.UserId);
                final EditText key = (EditText) loginView.findViewById(R.id.password);
